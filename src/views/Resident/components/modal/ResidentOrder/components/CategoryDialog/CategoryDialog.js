...
const CategoryDialog = props => {
  ...
  const { onOpen, onClose, categoryData, setCategoryData, categoryList, setCategoryList, setSelectedCategory, selectedCategory } = props;
  ...
  const categoryItems = () => {
      return categoryList.map((category, i) => {
          return <CategoryListComponent obj={category} idx={i} setCategoryList={setCategoryList}
            categoryData={categoryData} setCategoryData={setCategoryData} setSelectedCategory={setSelectedCategory} selectedCategory={selectedCategory} />;
      })
  }
